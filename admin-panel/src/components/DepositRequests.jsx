...
const DepositRequests = () => {
    ...
    useEffect(() => {
        fetch("https://task-8ibm.onrender.com/api/admin/deposits", {
            headers: {
    ...
    const handleApprove = (id) => {
        ...
        fetch(`https://task-8ibm.onrender.com/api/admin/deposits/${id}/approve`, {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${token}`, // Authorization header mein token bhejein
                "Content-Type": "application/json"
    ...
    const handleReject = (id) => {
        ...
        fetch(`https://task-8ibm.onrender.com/api/admin/deposits/${id}/reject`, {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${token}`, // Authorization header mein token bhejein
                "Content-Type": "application/json"
