...
const UsersManagement = () => {
    ...
    const handleSaveButton = () => {
        ...
        fetch(`https://task-8ibm.onrender.com/api/admin/user/${selectedUser._id}`, {
            method: "PUT",
            headers: {
    ...
    const handleReferralTree = (userId) => {
        fetch(`https://task-8ibm.onrender.com/api/admin/user/${userId}/referral-tree`, {
            headers: {
    ...
    const handleDeleteUser = (userId) => {
        if (window.confirm("Are you sure you want to delete this user?")) {
            fetch(`https://task-8ibm.onrender.com/api/admin/user/${userId}`, {
                method: "DELETE",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("adminToken")}`
                }
    ...
    const submitResetPassword = () => {
        ...
        fetch(`https://task-8ibm.onrender.com/api/admin/user/${selectedUser._id}/reset-password`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${localStorage.getItem("adminToken")}`
